...
namespace AMCDatabase
{
    ...
    public class PartsTable : PMTables
    {
        public string VERSION = "Version";
        public string LABELSCODE = "LabelsCode";

         public PartsTable(string sTable, string sKeyValue, string sVersion, bool bIsTest = false) : base(sTable, sKeyValue, "Partnumber", sVersion, bIsTest)
         {             
         }

//         public PartsTable(string sTableName, string sKeyValue, bool bIsTest = false)
//             : base(sTableName, sKeyValue, "Partnumber", bIsTest)
//         {
//         }
